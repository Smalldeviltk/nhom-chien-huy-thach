 ...
 * @author Mr
 */
class Admin_NamecardController extends Zend_Controller_Action {
    ...
    public function init() {
        $this->thiepTable = new Application_Model_Namecard();
        ...
        if (isset($_GET['edit']) && !empty($_GET['id'])) {//sua
            ...
            if ($this->getRequest()->isPost()) {
                ...
                if ($form->isValid($formData)) {
                    ...
                    $this->_forward('index', 'namecard', 'admin');
                } else {
